...
import os
from ofdm_fde_system_model_iqi_gamma import Result
from ofdm_fde_system_model_iqi_gamma import Params
...
if __name__ == '__main__':
    ...
    fig, ax = graph.new_ber_canvas("Training Epoch", params['graph_x_min'], params['graph_x_max'], -5)
